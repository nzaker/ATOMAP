...
class Atom_Position:
    ...
    def calculate_atom_position_intensity(
            self,
            image_data,
            intensity_type='max',
            percent_to_nn=0.40):
        """
        Find the intensity of the atom position.
        Maximum and minimum intensity are currently supported.

        The intensity is found within the distance to
        ...
        intensity_type : string, default 'max'
            the type of intensity you wish to calculate for the atom 
            position. 'max', 'min', and 'all' are currently supported.
            'max' and 'min' return floats.
            'all' returns a list of floats.
        ...
        Returns
        -------
        Pixel intensity for an atom position.
        ...
        >>> # 'max' intensity example
        >>> atom0_max_int = atom0.calculate_atom_position_intensity(
                                sublattice.image,
                                intensity_type='max')
        >>> # 'all' example returns list
        >>> atom0_all = atom0.calculate_atom_position_intensity(
                                sublattice.image,
                                intensity_type='all')
        """
        ...
        if intensity_type == 'max':
            ...
            data_slice = [data_slice_max, data_slice_min]
